...
import { IMicrofrontendsPersistence } from '../../src/persistence/IMicrofrontendsPersistence';
...
let MICROFRONTEND3: MicrofrontendV1 = {
    id: '3',
...
export class MicrofrontendsPersistenceFixture {
    ...
    private async testCreateMicrofrontends() {
        // Create one microfrontend
        let microfrontend = await this._persistence.create(null, MICROFRONTEND1);
        ...
        microfrontend = await this._persistence.create(null, MICROFRONTEND2);
        ...
        microfrontend = await this._persistence.create(null, MICROFRONTEND3);
    ...
    public async testCrudOperations() {
        ...
        // Create items
        await this.testCreateMicrofrontends();
        ...
        let microfrontend = await this._persistence.update(null, microfrontend1);
        ...
        await this._persistence.deleteById(null, microfrontend1.id);

        // Try to get delete microfrontend
        microfrontend = await this._persistence.getOneById(null, microfrontend1.id);
    ...
    public async testGetWithFilter() {
        ...
        let microfrontends = await this._persistence.getPageByFilter(null,
        ...
        microfrontends = await this._persistence.getPageByFilter(
            null,
            FilterParams.fromValue({
