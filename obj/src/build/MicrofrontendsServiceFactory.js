...
const MicrofrontendsCommandableHttpServiceV1_1 = require("../services/version1/MicrofrontendsCommandableHttpServiceV1");
...
class MicrofrontendsServiceFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(MicrofrontendsServiceFactory.HttpServiceDescriptor, MicrofrontendsCommandableHttpServiceV1_1.MicrofrontendsCommandableHttpServiceV1);
...
MicrofrontendsServiceFactory.HttpServiceDescriptor = new pip_services3_commons_nodex_1.Descriptor("service-microfrontends", "service", "commandable-http", "*", "1.0");
